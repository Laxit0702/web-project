...
const icon = searchboxinput.querySelector(
...
let digestive = ["stomach ache", "indigestion"];
let heart = ["high blood pressure"];
let anxiety = [
  "unable to concentrate",
  "increase focus",
  "not able to sleep properly",
];
let asthma = ["breathing problem", "difficulty in breathing"];
let joint = ["shoulder pain", "back pain", "neck pain", "tiredness"];
let diabetes = ["high sugar level"];
inputBox.onkeyup = (e) => {
